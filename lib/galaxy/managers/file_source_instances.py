...
class FileSourceInstancesManager:
    ...
    def test_modify_instance(
        self, trans: ProvidesUserContext, id: Union[str, int], payload: TestModifyInstancePayload
    ) -> PluginStatus:
        persisted_file_source = self._get(trans, id)
    ...
    def plugin_status_for_instance(self, trans: ProvidesUserContext, id: Union[str, int]):
        persisted_file_source = self._get(trans, id)
